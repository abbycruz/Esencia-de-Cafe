...
namespace Win.Esencia_de_Cafe {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(CategoriaRow parentCategoriaRowByCategoria_Producto, string Descripcion, double Precio, byte[] Foto, bool Activo) {
...
namespace Win.Esencia_de_Cafe.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([id] = @Original_id) AND ([Categoriaid] = @O" +
                "riginal_Categoriaid) AND ([Precio] = @Original_Precio) AND ([Activo] = @Original" +
                "_Activo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Producto] ([Categoriaid], [Descripcion], [Precio], [Foto], [Ac" +
                "tivo]) VALUES (@Categoriaid, @Descripcion, @Precio, @Foto, @Activo);\r\nSELECT id," +
                " Categoriaid, Descripcion, Precio, Foto, Activo FROM Producto WHERE (id = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Categoriaid] = @Categoriaid, [Descripcion] = @Descripcion, [Precio] = @Precio, [Foto] = @Foto, [Activo] = @Activo WHERE (([id] = @Original_id) AND ([Categoriaid] = @Original_Categoriaid) AND ([Precio] = @Original_Precio) AND ([Activo] = @Original_Activo));
SELECT id, Categoriaid, Descripcion, Precio, Foto, Activo FROM Producto WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Win.Esencia_de_Cafe.Properties.Settings.Default.CafesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Categoriaid, Descripcion, Precio, Foto, Activo FROM dbo.Producto";
        ...
        public virtual int Delete(int Original_id, int Original_Categoriaid, double Original_Precio, bool Original_Activo) {
        ...
        public virtual int Insert(int Categoriaid, string Descripcion, double Precio, byte[] Foto, bool Activo) {
        ...
        public virtual int Update(int Categoriaid, string Descripcion, double Precio, byte[] Foto, bool Activo, int Original_id, int Original_Categoriaid, double Original_Precio, bool Original_Activo, int id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Categoriaid, string Descripcion, double Precio, byte[] Foto, bool Activo, int Original_id, int Original_Categoriaid, double Original_Precio, bool Original_Activo) {
            return this.Update(Categoriaid, Descripcion, Precio, Foto, Activo, Original_id, Original_Categoriaid, Original_Precio, Original_Activo, Original_id);
        }
    }
